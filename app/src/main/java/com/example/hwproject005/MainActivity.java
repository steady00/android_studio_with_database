    ...
    private void displayAllData() {
        ...
        try {
            ...
            for (int i = 0; i < result.length(); i++) {
                ...
                String city = object.getString(Konfigurasi.TAG_JSON_KOTA);
                ...
                pegawai.put(Konfigurasi.TAG_JSON_KOTA, city);
        ...
        ListAdapter adapter = new SimpleAdapter(
                ...
                new String[]{Konfigurasi.TAG_JSON_ID, Konfigurasi.TAG_JSON_NAMA, Konfigurasi.TAG_JSON_KOTA},
                new int[]{R.id.txt_id, R.id.txt_name, R.id.txt_city}
        );
